...
declare module "sap/fe/macros/KPITag" {
   ...
   */
  export interface $KPITagSettings extends $BuildingBlockBaseSettings {
    /**
...
declare module "sap/fe/macros/MacroAPI" {
   ...
   */
  export interface $MacroAPISettings extends $BuildingBlockBaseSettings {
    /**
...
declare module "sap/fe/macros/MultiValueField" {
   ...
   * @experimental (since 1.118.0)
   */
  export interface $MultiValueFieldSettings extends $BuildingBlockBaseSettings {
    /**
...
declare module "sap/fe/macros/RichTextEditor" {
   ...
   * @since 1.117.0
   */
  export default class RichTextEditor extends BuildingBlockBase {}
  /**
   * Describes the settings that can be provided to the RichTextEditor constructor.
   */
  export interface $RichTextEditorSettings extends $BuildingBlockBaseSettings {
    /**
