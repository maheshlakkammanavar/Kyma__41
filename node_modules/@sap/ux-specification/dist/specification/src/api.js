...
exports.generateCustomExtension = exports.getApiVersion = exports.importProjectSchema = exports.importProject = exports.importConfig = exports.deleteConfigEntityByPath = exports.exportConfigEntityByPath = exports.exportConfig = exports.generateSchema = exports.prompts = exports.getGenericSchema = void 0;
/**
...
const FPMWriterMap = new Map([
    ...
    [ux_specification_types_1.CustomExtensionType.ListReport, fe_fpm_writer_1.generateListReport],
 ...
 */
exports.prompts = {
    api: fe_fpm_writer_1.PromptsAPI,
    types: fe_fpm_writer_1.PromptsType
};
/**
