    ...
    constructor(importParameters, home, pages, settings) {
        ...
        if (importParameters.fioriElementsVersion) {
            this.app.target = {
                ...
                odata: importParameters.fioriElementsVersion === ux_specification_types_1.FioriElementsVersion.v2
                    ? ux_specification_types_1.OdataVersion.v2
                    : ux_specification_types_1.OdataVersion.v4
            };
        }
